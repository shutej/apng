...
// widely supported in browsers, however, it can be an efficient way to
// represent raster graphics in a lossless encoding, for instance to overlay
// over a video with ffmpeg.
//
